...
https://github.com/ExamProCo/AWS-Examples/tree/main/global-accelerator
...
echo "== deploy global acc"

STACK_NAME="aws-global-acc-basic"
...
Resources:
  ...
  Accelerator:
    ...
    Properties:
      Name: sample-acc-1321
      Enabled: true
  EndpointGroup:
    Type: AWS::GlobalAccelerator::EndpointGroup
    Properties:
      ListenerArn: !Ref Listener
      EndpointGroupRegion: ca-central-1
      TrafficDialPercentage: 100
      EndpointConfigurations:
      - EndpointId: !GetAtt StaticIp.AllocationId
  Listener:
